...
setwd("G:/My Drive/R/r-scripts/worldTrans/Figure_FRIDApaper")
remove(list=ls())

# Get the energy variables from other IAMs
source('./get_variables_from_other_IAMs.R', local=TRUE)
source('./get_variables_from_FRIDA.R', local=TRUE)
...
agg_png("EMBvsSSP-Baselines.png", width = 16*3, height = 12*3, units = "in", res = 300, scaling = 3)
print(combined_plot)
dev.off()
